...
public class ExampleGyroscope : MonoBehaviour
{
    //smit's work

    //create a cube with camera vector names on the faces
    //allow the device to show the named faces as it is oriented.
    ...
    private void Start()
    {
        ...
        //make camera solid color and based at origin
        ...
        //quads[0] = createQuad(quad, new Vector3(1,0,0), new Vector3(0, 90, 0), "plus x", new Color(0.90f, 0.10f, 0.10f, 1), labels[0]);
